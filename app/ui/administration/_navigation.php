	...
	<div class="container">
		...
		<nav id="navbar-collapse-top" class="collapse navbar-collapse" role="navigation">
			<ul class="nav navbar-nav">
				...
				<li class="dropdown<?php if (\F3::get('PATTERN') == \F3::get('ALIASES.admin_reports')) echo ' active' ?>">
					...
					<ul class="dropdown-menu" role="menu">
						<li><a href="<?php echo str_replace('@reportName', 'officers_by_club', \F3::get('ALIASES.admin_reports')) ?>"><?php echo \F3::get('lang.AdminNavReportsOfficersByClub') ?></a></li>
					</ul>
				</li>
