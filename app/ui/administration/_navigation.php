			...
			<ul class="nav navbar-nav">
				...
				<li class="dropdown<?php if (substr(\F3::get('PATTERN'), 0, strrpos(\F3::get('PATTERN'), '/')) === substr(\F3::get('ALIASES.admin_reports'), 0, strrpos(\F3::get('ALIASES.admin_reports'), '/'))) echo ' active' ?>">
					...
					<ul class="dropdown-menu" role="menu">
						...
						<li><a href="<?php echo str_replace('@reportName', 'organizers_speakers', \F3::hive()['ALIASES']['admin_reports']) ?>"><?php echo \F3::get('lang.AdminNavReportsOrganizersSpeakers') ?></a></li>
						...
						<li><a href="<?php echo str_replace('@reportName', 'translators', \F3::hive()['ALIASES']['admin_reports']) ?>"><?php echo \F3::get('lang.AdminNavReportsTranslators') ?></a></li>
						...
						<li><a href="<?php echo str_replace('@reportName', 'waiting_list', \F3::hive()['ALIASES']['admin_reports']) ?>"><?php echo \F3::get('lang.AdminNavReportsWaitingList') ?></a></li>
