...
<div class="container">
	<div class="page-header">
		<h1><?php echo \F3::get('lang.HowRetrieveRegistration') ?></h1>
	</div>

	<p><?php echo \F3::get('lang.HowRetrieveRegistrationInfo', $email) ?></p>

	<ol>
		<li><?php echo \F3::get('lang.HowRetrieveRegistrationStep1') ?></li>
		<li><?php echo \F3::get('lang.HowRetrieveRegistrationStep2') ?></li>
	</ol>
